...
namespace SexsiPredictioner.SexsiPrediction.Extensions
{
    public static class Vector3Extensions
    {
        ...
        {
            var v = v1;
            v.Y = NavMesh.GetHeightForPosition(v1.X, v1.Z);
            ...
            var allyTurrets = ObjectManager
                .Get<Obj_AI_Turret>().Any(
                    t => t.IsAlly && point.Distance(t.Position)
                         < 950f + ObjectManager.Player.BoundingRadius + t.BoundingRadius);
            return allyTurrets;
        }
        ...
        {
            var miniMapPosition = Drawing.WorldToMinimap(worldPos);
        ...
        {
            var screenPosition = Drawing.WorldToScreen(worldPos);
