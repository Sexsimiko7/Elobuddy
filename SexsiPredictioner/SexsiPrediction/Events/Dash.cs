...
namespace SexsiPredictioner.SexsiPrediction.Events
{
    public static class Dash
    {
        ...
        static Dash()
        {
            EloBuddy.Obj_AI_Base.OnNewPath += OnObjAiHeroDash;
        }
        ...
        public static DashArgs GetDashInfo(this EloBuddy.Obj_AI_Base unit)
        {
            return DetectedDashes.TryGetValue(unit.NetworkId, out DashArgs value) ? value : new DashArgs();
        }

        public static bool IsDashing(this EloBuddy.Obj_AI_Base unit)
        {
        ...
        private static void OnObjAiHeroDash(EloBuddy.Obj_AI_Base sender, EloBuddy.GameObjectNewPathEventArgs args)
        {
            var hero = sender as EloBuddy.AIHeroClient;
            ...
            if (args.IsDash)
            {
                ...
                DetectedDashes[hero.NetworkId].StartTick = Environment.TickCount - EloBuddy.Game.Ping / 2;
        ...
        public class DashArgs : EventArgs
        {
            ...
            /// </summary>
            public EloBuddy.Obj_AI_Base Unit { get; set; }
