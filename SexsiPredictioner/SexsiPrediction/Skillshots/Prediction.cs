...
using SharpDX;
using SexsiPredictioner.SexsiPrediction.Events;
using SexsiPredictioner.SexsiPrediction.Skillshots.AoE;
...
namespace SexsiPrediction.Skillshots
{
    ...
    public class Prediction
    {
        ...
        internal static PredictionOutput GetPrediction(PredictionInput input, bool ft, bool checkCollision)
        {
            ...
            result.CollisionObjects = Collision.Collision.GetCollision(positions, input);
        ...
        internal static double UnitIsImmobileUntil(Obj_AI_Base unit)
        {
            var result = unit
                .Buffs.Where(
                    buff => buff.IsActive && Game.Time <= buff.EndTime && (buff.Type == BuffType.Charm
